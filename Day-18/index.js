...

{
  ...
  imageElem.setAttribute("src", "wallpapers.jpg");
  imageElem.setAttribute("alt", "wallpaper");
...

{
  ...
  mainDivElem.classList.toggle("test"); // test remove
  mainDivElem.classList.toggle("test"); // test add again
  */
}
